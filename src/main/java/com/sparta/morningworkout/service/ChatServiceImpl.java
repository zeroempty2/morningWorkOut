...
public class ChatServiceImpl implements ChatService {
    ...
    @Override
    @Transactional
    public StatusResponseDto sendChat(ChatRequestDto chatRequestDto, long senderId){
        Chat chat = Chat.builder().userId(senderId).contents(chatRequestDto.getMessage()).build();
