...
//
    ...
    void showProductBySeller() {
        ...
        given(productRepository.findAllByUserId(anyLong(), any())).willReturn(Page.empty());
//        Page<Product> products = productRepository.findAllByUserId(anyLong(), pageable);
//        given(productService.showProductBySeller(anyLong(), pageable)).willReturn(Page.empty());
//        given(products.map(ProductResponseDto:::new)).
        //when, then
        Page<ProductResponseDto> page = productService.showProductBySeller(user.getId(), pageable);
